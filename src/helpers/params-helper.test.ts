  ...
  describe("parseQueryParams", () => {
    ...
    describe("with only one parameter", () => {
      ...
      it("should decode URI components correctly", () => {
        expect(
          ParamsHelper.parseQueryParams(
            "?param%20with%2Bsymbols=value%20with%2Bsymbols",
          ),
        ).toEqual({
    ...
    describe("with duplicated parameters", () => {
      it("should return an object with only one key", () => {
        expect(
          ParamsHelper.parseQueryParams("?param1=value1&param1=value2"),
        ).toEqual({
          param1: "value2",
        });
      });
  ...
  describe("updateQueryParams", () => {
    ...
    describe("with no current params and new params", () => {
      ...
      it("should encode values correctly", () => {
        ...
        expect(params).toEqual(
          "?key%2Bwith%20symbols=%2B%2Bvalue%20with%20symbols",
        );
      });
    });
    ...
    describe("with current params and new params", () => {
      it("should output the correct string", () => {
        ...
        expect(params).toEqual(
          "?oldparam1=value1&param1=value1&param2=value2&param3=value3&param4=value4",
        );
      });
      ...
      it("should decode and re-encode old params correctly", () => {
        ...
        expect(params).toEqual(
          "?param%20with%20spaces=value%2Bplus&key%2Bwith%20symbols=%2B%2Bvalue%20with%20symbols",
        );
      });
